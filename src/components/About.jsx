...
export const About = () => {
    ...
    return (
        ...
        <section className=" md:flex md:justify-center md:items-center md:h-[760px] bg-[#171717] ">
            ...
            <article className=" h-[535px] sm:h-[400px] md:flex flex-col justify-center bg-[#f55138e0]
            ...
            <div>
                <Fade fraction={0.8} triggerOnce={true} >
                    <img className=" m-auto relative bottom-20 max-h-[320px] sm:max-h-[500px] sm:relative
